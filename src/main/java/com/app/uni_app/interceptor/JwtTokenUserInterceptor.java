package com.app.uni_app.interceptor;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            UserInfo userInfo = UserInfo.builder().id(userId)
                    .nickname(claims.get(JwtTokenClaimsConstant.NICK_NAME).toString())
                    .openid(claims.get(JwtTokenClaimsConstant.OPEN_ID).toString())
                    .build();
